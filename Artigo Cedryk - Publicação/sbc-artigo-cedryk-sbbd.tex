...
%(ANTIGO)Os Bancos de Dados~\emph{NoSQL} são mais flexíveis perante o escalonamento horizontal, possibilitando a distribuição de recursos com a adição de nós. 
